...
namespace RazorTemplateEngine
{
    ...
    public static class ThePresenter
    {
        ...
        internal static string LoadTemplate(string templateName)
        {
            ...
            using (Stream input = assembly.GetManifestResourceStream($"DotNetCoreExample.{templateName}"))
        ...
        {
            var assembly = Assembly.GetExecutingAssembly();
            return assembly.GetManifestResourceStream($"DotNetCoreExample.{resourceName}");
        }
